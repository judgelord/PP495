...
Critiquing those we severely disagree with is easy, but they are also the least likely to listen to you. Thus, the critiques you develop in this class will be aimed at the organizations you see as having the best chance of making a positive difference in the world---specifically, the organizations for whom you hope to work. You may not know what your future career looks like; that is fine. Perhaps you will find an organization or cause that inspires you in this class. Or perhaps you have a very clear idea of your future career. In that case, this class will challenge you to think about how organizations in your intended field of work engage in politics and policymaking---and how they might do so differently. It is not required that the organizations you address be activist organizations. Indeed, activist organizations may be the most difficult to critique because they already have a well-developed approach to politics and policy. You may even see yourself working for an organization that is currently strongly opposed to most proposed climate policies; that is fine. For example, if you aim to work at Exxon-Mobil, you might look to Business School scholarship to formulate a critique like [this one](https://ssir.org/articles/entry/time_to_put_the_fossil_fuel_industry_into_hospice). 
...
<mark> The critical element is *your personal journey*---details about your life experiences that lead you to have the opinions and critiques you do and help the readers see the world through your eyes, and, hopefully, come to share your perspective. </mark>

Because finding firm ground from which to speak authoritatively is a challenge, for every 200 words of writing, you should include one **original evidence** that adds credibility to your claims. 
These must take the form of an image or video (<1 minute). 
Some ideas: 
...
- A clip from an archived video or an archival document that has not previously been used to support the point you are making (if a video clip, picture, or document has already been used to make the same point you are making, you are not adding to the conversation and thus not helping yourself speak with distinct authority)
- Art that moves the reader to see from the perspective you are trying to advance
- A survey of fellow students or community members
- A composite image that shows a comparison or contradiction
...
Include a word count between the title and the essay. Getting in under the word limit should thus be a major challenge with this assignment. I am expecting the kind of writing where every word you must cut to hit the target is painful. Thus, I expect the word count to be nearly exactly the word limit (perhaps a few words shorter).
...
- Five revised headlines and the first 200 words for each (+ 1-2 bits of original visual evidence for each + annotated bibliographic footnotes, which do not count toward the word limit) 

<div class="transparent">
Maizey, please incorporate into each op-ed-style headline and essay how the organization may impact the climate by using LLMs in its work, and how working for that organization requires creative or original thinking that could be inhibited by using LLMs for first drafts.
</div>
...
Use footnotes for annotated bibliographies to make it easier for your peer reviewers, me, and future editors to connect what you say in the essay to the citation. If your op-ed is published, citations will likely take the form of hyperlinks, perhaps with endnotes or margin notes for some online publications. 
...
I expect the annotated bibliographies to grow significantly as you address critiques, bolster your argument, and respond to potential counterarguments. 

As above, include a word count between the title and the essay.

#### Responding to comments 

Each time you submit your revised essays, you must include a Google sheet detailing your thoughtful responses to all of the comments you have received thus far. This spreadsheet must have a row for each suggestion, with columns for the exact text of the suggestion, who made it, what you think about it, and any change (if any) made to the essay. This is your opportunity to show your work as you revise. 
...
To be clear, you do not need to include all of my exact comments in the spreadsheet (though you are welcome to do so if you are comfortable sharing them); paraphrasing is fine. The key is to communicate the gist of each piece of feedback so your peer reviewer can help you ensure it is "thoughtfully addressed" in the next draft. 
...
You must share this spreadsheet with me each time you resubmit your revised essay(s). <mark>Put a link to your Google sheet at the top of your essay.</mark> I am primarily grading on how you respond to feedback, so I will use this spreadsheet as something like a rubric to assess your thoughtful engagement with my feedback and your peer reviews.

It is up to you whether you want to share this spreadsheet with your peer reviewers. 

### Hone your critique 

Through additional rounds of revision, you will further hone one of your critiques, improving your logic and writing (We can always improve our writing). 

Again, I expect your annotated bibliography to grow significantly as you address critiques, bolster your argument, and respond to potential counterarguments. 
...
Assessment is based on your <mark> thoughtful engagement with the ideas</mark> in the reading and with my feedback on your writing. 
...
Instead, consider the feedback I give you and your peer reviews to be the "rubric" for the next version. <mark> I am mostly grading on how you respond to feedback.</mark>  This does not mean that you must adopt every suggested change---just that you thoughtfully engage with them. You may choose not to adopt a change or go in a direction I suggest; that is totally fine as long as you have a good reason. <!--If you would like, you can include revision comments on the document in Canvas, addressing any points where you feel context is needed for me to understand how you incorporated feedback.--> 
...
- Any personal examples and observations are very relevant to your larger thesis/message
...
The presentation assignment gives you practice testing out your argument and presentation skills. This is an opportunity to get quick feedback from the class. I also find that I can arrive at more elegant ways to say things when I say them out loud. It engages different parts of the brain and is a great way to workshop ideas.
...
I hope you find it valuable enough to want to do it again, but you are only required to do it once. 

We will do up to 2 pitches per day. While you are welcome to do more than one, the priority goes to those practicing for the first time. 

I've noticed a tendency among some presenters to offer a lot of preamble and explanation before getting to the heart of their pitch. I think you are better off without it. 
...
This means <mark> at least a page of written feedback</mark>  (when reviewing multiple essays, this minimum is for all of them combined---though a page on each essay would be great), <mark> as well as some notes or markup of their writing.</mark>  We can alwasy improve our writing. 

### How to submit your review

You can use the <mark>markup features on Canvas</mark> as you read. </mark> You should then upload your written critique for the peer critique assignment **and** sent to your colleague.</mark>  (You should be able to share a Google Doc or attach a file in the "Comments for this Attempt" bar on Canvas.) <mark> Make sure to submit it in both places.</mark>  The assignment upload goes to me so that you get credit for the assignment. The "Comments for this attempt" make it available to your colleague.
